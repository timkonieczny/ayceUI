...
var showProperties = function(e) {
    ...
    var setDefaultValues = function() {
        ...
        if (uiFactory.camera) {
            ...
            document.getElementById("specular_color_r").value = objects[currentObjectId].specularColor.red;
            document.getElementById("specular_color_g").value = objects[currentObjectId].specularColor.green;
            document.getElementById("specular_color_b").value = objects[currentObjectId].specularColor.blue;
        }
        if (uiFactory.camera) {
