...
//Scene Management
    ...
    this.updateScene = function () {
        ...
        for(i=0; i < identificationBufferObjects.length; i++){
            identificationBufferObjects[i].update();
        }
        renderer.update(camera, objects, transparentObjects, identificationBufferObjects);
    ...
    // TODO: move picking to ayce core code
    ...
    this.addToScene = function (object, enablePicking) {
        ...
        //Add O3D to Scene
            ...
            if(enablePicking) {
                if(currentIdentifier.r<1) currentIdentifier.r+=1/255;
                else if(currentIdentifier.g<1) currentIdentifier.g+=1/255;
                else if(currentIdentifier.b<1) currentIdentifier.b+=1/255;
                else console.error("Depth of identification buffer is reached");
    ...
    /**
     * Returns object identifier of object at given coordinates in screen space.
     * @param {Number} x
     * @param {Number} y
     */
    this.getPickedIdentifier = function(x, y){
        return renderer.getObjectIdentifierAt(x, y, identificationBufferObjects);
    };
